...
dict = {}
for line in open('/Users/zhaosanqiang916/git/keyphrase/data/dummy_abstr.voc'):
    items = line.split('\t')
    word = items[0]
    cnt = int(items[1])
    dict[word] = cnt
...
c = Counter(dict)
output_path = "/Users/zhaosanqiang916/git/keyphrase/data/dummy_abstr.subvoc"
sub_word = SubwordTextEncoder.build_to_target_size(5, c, 1, 1e3,
                                                               num_iterations=100)
